...
function Selayar() {
  ...
  // Fungsi 2: Analisis SKP (Upload File)
  ...
  const handleAnalyzeSkp = async () => {
    if (!selectedSkp) {
      setError('Error: Silakan pilih file SKP (PDF/TXT) terlebih dahulu.');
      return;
    }
    setLoadingSkp(true);
    setSkpResult('');
  ...
  return (
    <div className="module-container">
      ...
      <div className="card" style={{ marginBottom: '20px' }}>
        ...
        {loadingSentiment && <p>Menarik berita dari Google dan menganalisis...</p>}
        ...
        {sentimentResult && (
          <div style={{ marginTop: '20px' }}>
            ...
            <h4 style={{color: 'var(--accent-blue)', marginTop: '20px'}}>Sumber Google Search:</h4>
      ...
      {/* Bagian 2: Analisis Artefak Kinerja */}
      <div className="card">
            ...
            <AiOutput text={skpResult} />
             {finalPerformanceScore !== null && (
              <p style={{ marginTop: '15px', fontWeight: 'bold', color: 'var(--accent-blue)' }}>
                SKOR KINERJA FINAL: {finalPerformanceScore} / 100
              </p>
            )}
          </div>
        )}
