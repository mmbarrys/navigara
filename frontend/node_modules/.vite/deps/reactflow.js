...
var require_use_sync_external_store_shim_development = /* @__PURE__ */ __commonJS({ "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js": ((exports) => {
	(function() {
		...
		function useSyncExternalStore$2(subscribe, getSnapshot) {
			didWarnOld18Alpha || void 0 === React$6.startTransition || (didWarnOld18Alpha = !0, console.error("You are using an outdated, pre-release alpha of React 18 that does not support useSyncExternalStore. The use-sync-external-store shim will not work correctly. Upgrade to a newer pre-release."));
		...
		var React$6 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState$2 = React$6.useState, useEffect$4 = React$6.useEffect, useLayoutEffect = React$6.useLayoutEffect, useDebugValue$1 = React$6.useDebugValue, didWarnOld18Alpha = !1, didWarnUncachedGetSnapshot = !1, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = /* @__PURE__ */ __commonJS({ "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js": ((exports) => {
	(function() {
		...
		"undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
		var React$6 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef$4 = React$6.useRef, useEffect$4 = React$6.useEffect, useMemo$1 = React$6.useMemo, useDebugValue$1 = React$6.useDebugValue;
		exports.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector$11, isEqual) {
			...
			instRef = useMemo$1(function() {
				function memoizedSelector(nextSnapshot) {
					if (!hasMemo) {
						...
						nextSnapshot = selector$11(nextSnapshot);
					...
					var nextSelection = selector$11(nextSnapshot);
...
var createStoreImpl = (createState) => {
	...
	const initialState$1 = state = createState(setState, getState, api);
	return api;
};
...
function useStoreWithEqualityFn(api, selector$11 = identity$2, equalityFn) {
	const slice = useSyncExternalStoreWithSelector(api.subscribe, api.getState, api.getServerState || api.getInitialState, selector$11, equalityFn);
	useDebugValue(slice);
	return slice;
}
var createWithEqualityFnImpl = (createState, defaultEqualityFn) => {
	const api = createStore(createState);
	const useBoundStoreWithEqualityFn = (selector$11, equalityFn = defaultEqualityFn) => useStoreWithEqualityFn(api, selector$11, equalityFn);
...
function none() {}
function selector_default(selector$11) {
	return selector$11 == null ? none : function() {
		return this.querySelector(selector$11);
	};
}
...
function selectorAll_default(selector$11) {
	return selector$11 == null ? empty : function() {
		return this.querySelectorAll(selector$11);
	};
}
...
function matcher_default(selector$11) {
	return function() {
		return this.matches(selector$11);
	};
}
function childMatcher(selector$11) {
	return function(node) {
		return node.matches(selector$11);
	};
}
...
EnterNode.prototype = {
	...
	querySelector: function(selector$11) {
		return this._parent.querySelector(selector$11);
	},
	querySelectorAll: function(selector$11) {
		return this._parent.querySelectorAll(selector$11);
	}
};
...
function select_default(selector$11) {
	return typeof selector$11 === "string" ? new Selection$1([[document.querySelector(selector$11)]], [document.documentElement]) : new Selection$1([[selector$11]], root);
}
...
function nodrag_default(view) {
	var root$1 = view.document.documentElement, selection$1 = select_default(view).on("dragstart.drag", noevent_default$1, nonpassivecapture);
	if ("onselectstart" in root$1) selection$1.on("selectstart.drag", noevent_default$1, nonpassivecapture);
	else {
		root$1.__noselect = root$1.style.MozUserSelect;
		root$1.style.MozUserSelect = "none";
	}
}
function yesdrag(view, noclick) {
	var root$1 = view.document.documentElement, selection$1 = select_default(view).on("dragstart.drag", null);
	if (noclick) {
	...
	if ("onselectstart" in root$1) selection$1.on("selectstart.drag", null);
	else {
		root$1.style.MozUserSelect = root$1.__noselect;
		delete root$1.__noselect;
	}
}
...
function DragEvent(type, { sourceEvent, subject, target, identifier, active, x, y, dx, dy, dispatch: dispatch$1 }) {
...
function drag_default() {
	...
	function mousedowned(event, d) {
		if (touchending || !filter$1.call(this, event, d)) return;
	...
	function touchstarted(event, d) {
		if (!filter$1.call(this, event, d)) return;
	...
	function beforestart(that, container$1, event, d, identifier, touch) {
		var dispatch$1 = listeners.copy(), p = pointer_default(touch || event, container$1), dx, dy, s;
	...
	drag.filter = function(_) {
		return arguments.length ? (filter$1 = typeof _ === "function" ? _ : constant_default$2(!!_), drag) : filter$1;
	};
...
function zoom_default() {
	...
	zoom.scaleBy = function(selection$1, k, p, event) {
		zoom.scaleTo(selection$1, function() {
			var k0 = this.__zoom.k, k1 = typeof k === "function" ? k.apply(this, arguments) : k;
			return k0 * k1;
		}, p, event);
	};
	zoom.scaleTo = function(selection$1, k, p, event) {
		zoom.transform(selection$1, function() {
			var e = extent.apply(this, arguments), t0 = this.__zoom, p0 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p, p1 = t0.invert(p0), k1 = typeof k === "function" ? k.apply(this, arguments) : k;
			return constrain(translate(scale(t0, k1), p0, p1), e, translateExtent);
		}, p, event);
	};
	zoom.translateBy = function(selection$1, x, y, event) {
		zoom.transform(selection$1, function() {
			return constrain(this.__zoom.translate(typeof x === "function" ? x.apply(this, arguments) : x, typeof y === "function" ? y.apply(this, arguments) : y), extent.apply(this, arguments), translateExtent);
		}, null, event);
	};
	zoom.translateTo = function(selection$1, x, y, p, event) {
		zoom.transform(selection$1, function() {
	...
	function schedule(transition$1, transform$1, point, event) {
		transition$1.on("start.zoom", function() {
			...
			var that = this, args = arguments, g = gesture(that, args).event(event), e = extent.apply(that, args), p = point == null ? centroid(e) : typeof point === "function" ? point.apply(that, args) : point, w = Math.max(e[1][0] - e[0][0], e[1][1] - e[0][1]), a = that.__zoom, b = typeof transform$1 === "function" ? transform$1.apply(that, args) : transform$1, i = interpolate(a.invert(p).concat(w / a.k), b.invert(p).concat(w / b.k));
			return function(t) {
				if (t === 1) t = b;
				else {
					var l = i(t), k = w / l[2];
	...
	function wheeled(event, ...args) {
		...
		var g = gesture(this, args).event(event), t = this.__zoom, k = Math.max(scaleExtent[0], Math.min(scaleExtent[1], t.k * Math.pow(2, wheelDelta$1.apply(this, arguments)))), p = pointer_default(event);
		if (g.wheel) {
	...
	zoom.wheelDelta = function(_) {
		return arguments.length ? (wheelDelta$1 = typeof _ === "function" ? _ : constant_default(+_), zoom) : wheelDelta$1;
	};
	zoom.filter = function(_) {
		return arguments.length ? (filter$1 = typeof _ === "function" ? _ : constant_default(!!_), zoom) : filter$1;
	};
...
var errorMessages = {
	...
	error007: (id$1) => `The old edge with id=${id$1} does not exist.`,
	error009: (type) => `Marker type "${type}" doesn't exist.`,
	error008: (sourceHandle, edge) => `Couldn't create edge for ${!sourceHandle ? "source" : "target"} handle id: "${!sourceHandle ? edge.sourceHandle : edge.targetHandle}", edge id: ${edge.id}.`,
	error010: () => "Handle: No node id found. Make sure to only use a Handle inside a custom Node.",
	error011: (edgeType) => `Edge type "${edgeType}" not found. Using fallback type "default".`,
	error012: (id$1) => `Node with id "${id$1}" does not exist, it may have been removed. This can happen when a node is deleted before the "onNodeClick" handler is called.`
};
var zustandErrorMessage = errorMessages["error001"]();
function useStore(selector$11, equalityFn) {
	const store = (0, import_react.useContext)(StoreContext);
	if (store === null) throw new Error(zustandErrorMessage);
	return useStoreWithEqualityFn(store, selector$11, equalityFn);
}
var useStoreApi = () => {
	const store = (0, import_react.useContext)(StoreContext);
	if (store === null) throw new Error(zustandErrorMessage);
...
function Panel({ position, children: children$1, className, style: style$1,...rest }) {
...
var EdgeText = ({ x, y, label, labelStyle = {}, labelShowBg = true, labelBgStyle = {}, labelBgPadding = [2, 4], labelBgBorderRadius = 2, children: children$1, className,...rest }) => {
...
var devWarn = (id$1, message) => {
	console.warn(`[React Flow]: ${message} Help: https://reactflow.dev/error#${id$1}`);
};
...
var BaseEdge = ({ id: id$1, path, labelX, labelY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style$1, markerEnd, markerStart, interactionWidth = 20 }) => {
...
function getMouseHandler$1(id$1, getState, handler) {
	return handler === void 0 ? handler : (event) => {
		const edge = getState().edges.find((e) => e.id === id$1);
...
var ConnectionMode;
(function(ConnectionMode$1) {
	ConnectionMode$1["Strict"] = "strict";
	ConnectionMode$1["Loose"] = "loose";
})(ConnectionMode || (ConnectionMode = {}));
var PanOnScrollMode;
(function(PanOnScrollMode$1) {
	PanOnScrollMode$1["Free"] = "free";
	PanOnScrollMode$1["Vertical"] = "vertical";
	PanOnScrollMode$1["Horizontal"] = "horizontal";
})(PanOnScrollMode || (PanOnScrollMode = {}));
var SelectionMode;
(function(SelectionMode$1) {
	SelectionMode$1["Partial"] = "partial";
	SelectionMode$1["Full"] = "full";
})(SelectionMode || (SelectionMode = {}));
var ConnectionLineType;
(function(ConnectionLineType$1) {
	ConnectionLineType$1["Bezier"] = "default";
	ConnectionLineType$1["Straight"] = "straight";
	ConnectionLineType$1["Step"] = "step";
	ConnectionLineType$1["SmoothStep"] = "smoothstep";
	ConnectionLineType$1["SimpleBezier"] = "simplebezier";
})(ConnectionLineType || (ConnectionLineType = {}));
var MarkerType;
(function(MarkerType$1) {
	MarkerType$1["Arrow"] = "arrow";
	MarkerType$1["ArrowClosed"] = "arrowclosed";
...
var SimpleBezierEdge = (0, import_react.memo)(({ sourceX, sourceY, targetX, targetY, sourcePosition = Position.Bottom, targetPosition = Position.Top, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style$1, markerEnd, markerStart, interactionWidth }) => {
...
function getBend(a, b, c, size) {
	...
	if (a.y === y) {
		const xDir$1 = a.x < c.x ? -1 : 1;
		const yDir$1 = a.y < c.y ? 1 : -1;
		return `L ${x + bendSize * xDir$1},${y}Q ${x},${y} ${x},${y + bendSize * yDir$1}`;
	}
...
var SmoothStepEdge = (0, import_react.memo)(({ sourceX, sourceY, targetX, targetY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style$1, sourcePosition = Position.Bottom, targetPosition = Position.Top, markerEnd, markerStart, pathOptions, interactionWidth }) => {
...
var StraightEdge = (0, import_react.memo)(({ sourceX, sourceY, targetX, targetY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style$1, markerEnd, markerStart, interactionWidth }) => {
...
function calculateControlOffset(distance$1, curvature) {
	if (distance$1 >= 0) return .5 * distance$1;
	return curvature * 25 * Math.sqrt(-distance$1);
}
...
var BezierEdge = (0, import_react.memo)(({ sourceX, sourceY, targetX, targetY, sourcePosition = Position.Bottom, targetPosition = Position.Top, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style$1, markerEnd, markerStart, pathOptions, interactionWidth }) => {
...
var getD3Transition = (selection$1, duration = 0) => {
	return selection$1.transition().duration(duration);
};
...
function getClosestHandle(event, doc, pos, connectionRadius, handles, validator) {
	...
	handles.forEach((handle) => {
		const distance$1 = Math.sqrt((handle.x - pos.x) ** 2 + (handle.y - pos.y) ** 2);
		if (distance$1 <= connectionRadius) {
			const validHandleResult = validator(handle);
			if (distance$1 <= minDistance) {
				if (distance$1 < minDistance) closestHandles = [{
					handle,
					validHandleResult
				}];
				else if (distance$1 === minDistance) closestHandles.push({
					handle,
					validHandleResult
				});
...
function handlePointerDown({ event, handleId, nodeId, onConnect, isTarget, getState, setState, isValidConnection, edgeUpdaterType, onReconnectEnd }) {
	...
	function onPointerMove(event$1) {
		const { transform: transform$1 } = getState();
		connectionPosition = getEventPosition(event$1, containerBounds);
		const { handle, validHandleResult } = getClosestHandle(event$1, doc, pointToRendererPoint(connectionPosition, transform$1, false, [1, 1]), connectionRadius, handleLookup, (handle$1) => isValidHandle(handle$1, connectionMode, nodeId, handleId, isTarget ? "target" : "source", isValidConnection, doc));
		...
		setState({
			connectionPosition: closestHandle && isValid ? rendererPointToPoint({
				x: closestHandle.x,
				y: closestHandle.y
			}, transform$1) : connectionPosition,
	...
	function onPointerUp(event$1) {
		if ((closestHandle || handleDomNode) && connection && isValid) onConnect?.(connection);
		getState().onConnectEnd?.(event$1);
		if (edgeUpdaterType) onReconnectEnd?.(event$1);
		resetRecentHandle(prevActiveHandle);
		cancelConnection();
...
var Handle = (0, import_react.forwardRef)(({ type = "source", position = Position.Top, isValidConnection, isConnectable = true, isConnectableStart = true, isConnectableEnd = true, id: id$1, onConnect, children: children$1, className, onMouseDown, onTouchStart,...rest }, ref) => {
	const handleId = id$1 || null;
...
var StoreUpdater = ({ nodes, edges, defaultNodes, defaultEdges, onConnect, onConnectStart, onConnectEnd, onClickConnectStart, onClickConnectEnd, nodesDraggable, nodesConnectable, nodesFocusable, edgesFocusable, edgesUpdatable, elevateNodesOnSelect, minZoom, maxZoom, nodeExtent, onNodesChange, onEdgesChange, elementsSelectable, connectionMode, snapGrid, snapToGrid, translateExtent, connectOnClick, defaultEdgeOptions, fitView: fitView$1, fitViewOptions, onNodesDelete, onEdgesDelete, onNodeDrag, onNodeDragStart, onNodeDragStop, onSelectionDrag, onSelectionDragStart, onSelectionDragStop, noPanClassName, nodeOrigin, rfId, autoPanOnConnect, autoPanOnNodeDrag, onError, connectionRadius, isValidConnection, nodeDragThreshold }) => {
	...
	useDirectStoreUpdater("fitViewOnInit", fitView$1, store.setState);
...
function fitView(get$2, options = {}) {
	const { getNodes, width, height, minZoom, maxZoom, d3Zoom, d3Selection, fitViewOnInitDone, fitViewOnInit, nodeOrigin } = get$2();
	...
	if (d3Zoom && d3Selection && (isInitialFitView || !options.initial)) {
		...
		if (nodes.length > 0 && nodesInitialized) {
			...
			const { x, y, zoom } = getViewportForBounds(bounds, width, height, options.minZoom ?? minZoom, options.maxZoom ?? maxZoom, options.padding ?? .1);
...
function handleControlledEdgeSelectionChange(edgeChanges, edges) {
	return edges.map((e) => {
		const change = edgeChanges.find((change$1) => change$1.id === e.id);
		if (change) e.selected = change.selected;
		return e;
	});
}
function updateNodesAndEdgesSelections({ changedNodes, changedEdges, get: get$2, set: set$2 }) {
	const { nodeInternals, edges, onNodesChange, onEdgesChange, hasDefaultNodes, hasDefaultEdges } = get$2();
	if (changedNodes?.length) {
		if (hasDefaultNodes) set$2({ nodeInternals: handleControlledNodeSelectionChange(changedNodes, nodeInternals) });
		onNodesChange?.(changedNodes);
	}
	if (changedEdges?.length) {
		if (hasDefaultEdges) set$2({ edges: handleControlledEdgeSelectionChange(changedEdges, edges) });
...
var useViewportHelper = () => {
	...
	return (0, import_react.useMemo)(() => {
		if (d3Selection && d3Zoom) return {
			...
			setViewport: (transform$1, options) => {
				const [x, y, zoom] = store.getState().transform;
				const nextTransform = identity.translate(transform$1.x ?? x, transform$1.y ?? y).scale(transform$1.zoom ?? zoom);
			...
			setCenter: (x, y, options) => {
				...
				const transform$1 = identity.translate(centerX, centerY).scale(nextZoom);
				d3Zoom.transform(getD3Transition(d3Selection, options?.duration), transform$1);
			},
			fitBounds: (bounds, options) => {
				const { width, height, minZoom, maxZoom } = store.getState();
				const { x, y, zoom } = getViewportForBounds(bounds, width, height, minZoom, maxZoom, options?.padding ?? .1);
				const transform$1 = identity.translate(x, y).scale(zoom);
				d3Zoom.transform(getD3Transition(d3Selection, options?.duration), transform$1);
			},
			project: (position) => {
				const { transform: transform$1, snapToGrid, snapGrid } = store.getState();
				console.warn("[DEPRECATED] `project` is deprecated. Instead use `screenToFlowPosition`. There is no need to subtract the react flow bounds anymore! https://reactflow.dev/api-reference/types/react-flow-instance#screen-to-flow-position");
				return pointToRendererPoint(position, transform$1, snapToGrid, snapGrid);
			},
			screenToFlowPosition: (position) => {
				const { transform: transform$1, snapToGrid, snapGrid, domNode } = store.getState();
				...
				return pointToRendererPoint(relativePosition, transform$1, snapToGrid, snapGrid);
			},
			flowToScreenPosition: (position) => {
				const { transform: transform$1, domNode } = store.getState();
				if (!domNode) return position;
				const { x: domX, y: domY } = domNode.getBoundingClientRect();
				const rendererPosition = rendererPointToPoint(position, transform$1);
				return {
...
function useReactFlow() {
	...
	const getNode = (0, import_react.useCallback)((id$1) => {
		return store.getState().nodeInternals.get(id$1);
	}, []);
	const getEdges = (0, import_react.useCallback)(() => {
		const { edges = [] } = store.getState();
		return edges.map((e) => ({ ...e }));
	}, []);
	const getEdge = (0, import_react.useCallback)((id$1) => {
		const { edges = [] } = store.getState();
		return edges.find((e) => e.id === id$1);
	}, []);
	const setNodes = (0, import_react.useCallback)((payload) => {
		const { getNodes: getNodes$1, setNodes: setNodes$1, hasDefaultNodes, onNodesChange } = store.getState();
		const nodes = getNodes$1();
		const nextNodes = typeof payload === "function" ? payload(nodes) : payload;
		if (hasDefaultNodes) setNodes$1(nextNodes);
	...
	const setEdges = (0, import_react.useCallback)((payload) => {
		const { edges = [], setEdges: setEdges$1, hasDefaultEdges, onEdgesChange } = store.getState();
		const nextEdges = typeof payload === "function" ? payload(edges) : payload;
		if (hasDefaultEdges) setEdges$1(nextEdges);
	...
	const addNodes = (0, import_react.useCallback)((payload) => {
		...
		const { getNodes: getNodes$1, setNodes: setNodes$1, hasDefaultNodes, onNodesChange } = store.getState();
		if (hasDefaultNodes) {
			const nextNodes = [...getNodes$1(), ...nodes];
			setNodes$1(nextNodes);
		} else if (onNodesChange) {
	...
	const addEdges = (0, import_react.useCallback)((payload) => {
		...
		const { edges = [], setEdges: setEdges$1, hasDefaultEdges, onEdgesChange } = store.getState();
		if (hasDefaultEdges) setEdges$1([...edges, ...nextEdges]);
		else if (onEdgesChange) {
	...
	const toObject = (0, import_react.useCallback)(() => {
		const { getNodes: getNodes$1, edges = [], transform: transform$1 } = store.getState();
		const [x, y, zoom] = transform$1;
		return {
			nodes: getNodes$1().map((n) => ({ ...n })),
			edges: edges.map((e) => ({ ...e })),
			viewport: {
				x,
				y,
	...
	const deleteElements = (0, import_react.useCallback)(({ nodes: nodesDeleted, edges: edgesDeleted }) => {
		const { nodeInternals, getNodes: getNodes$1, edges, hasDefaultNodes, hasDefaultEdges, onNodesDelete, onEdgesDelete, onNodesChange, onEdgesChange } = store.getState();
		const nodeIds = (nodesDeleted || []).map((node) => node.id);
		const edgeIds = (edgesDeleted || []).map((edge) => edge.id);
		const nodesToRemove = getNodes$1().reduce((res, node) => {
			const parentId = node.parentNode || node.parentId;
		...
		if (nodesToRemove || initialHitEdges) {
			...
			if (edgeIdsToRemove.length > 0) {
				...
				if (onEdgesChange) onEdgesChange(edgeIdsToRemove.map((id$1) => ({
					id: id$1,
					type: "remove"
				})));
			}
...
var ZoomPane = ({ onMove, onMoveStart, onMoveEnd, onPaneContextMenu, zoomOnScroll = true, zoomOnPinch = true, panOnScroll = false, panOnScrollSpeed = .5, panOnScrollMode = PanOnScrollMode.Free, zoomOnDoubleClick = true, elementsSelectable, panOnDrag = true, defaultViewport, translateExtent, minZoom, maxZoom, zoomActivationKeyCode, preventScrolling = true, children: children$1, noWheelClassName, noPanClassName }) => {
	...
	(0, import_react.useEffect)(() => {
		if (zoomPane.current) {
			...
			const selection$1 = select_default(zoomPane.current).call(d3ZoomInstance);
			...
			d3ZoomInstance.transform(selection$1, constrainedTransform);
			d3ZoomInstance.wheelDelta(wheelDelta);
			store.setState({
				d3Zoom: d3ZoomInstance,
				d3Selection: selection$1,
				d3ZoomHandler: selection$1.on("wheel.zoom"),
				transform: [
...
var createSelectionChange = (id$1, selected) => ({
	id: id$1,
	type: "select",
	selected
});
...
var Pane = (0, import_react.memo)(({ isSelecting, selectionMode = SelectionMode.Full, panOnDrag, onSelectionStart, onSelectionEnd, onPaneClick, onPaneContextMenu, onPaneScroll, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, children: children$1 }) => {
	...
	const onMouseMove = (event) => {
		const { userSelectionRect, nodeInternals, edges, transform: transform$1, onNodesChange, onEdgesChange, nodeOrigin, getNodes } = store.getState();
		...
		const selectedNodes = getNodesInside(nodeInternals, nextUserSelectRect, transform$1, selectionMode === SelectionMode.Partial, true, nodeOrigin);
	...
	return import_react.createElement("div", {
		...
		ref: container,
		style: containerStyle
	}, children$1, import_react.createElement(UserSelection, null));
});
...
function hasSelector(target, selector$11, nodeRef) {
	let current = target;
	do {
		if (current?.matches(selector$11)) return true;
...
var getHandleBounds = (selector$11, nodeElement, zoom, nodeOrigin) => {
	const handles = nodeElement.querySelectorAll(selector$11);
...
function getMouseHandler(id$1, getState, handler) {
	return handler === void 0 ? handler : (event) => {
		const node = getState().nodeInternals.get(id$1);
		if (node) handler(event, { ...node });
	};
}
function handleNodeClick({ id: id$1, store, unselect = false, nodeRef }) {
	const { addSelectedNodes, unselectNodesAndEdges, multiSelectionActive, nodeInternals, onError } = store.getState();
	const node = nodeInternals.get(id$1);
	if (!node) {
		onError?.("012", errorMessages["error012"](id$1));
		return;
	}
	store.setState({ nodesSelectionActive: false });
	if (!node.selected) addSelectedNodes([id$1]);
...
function useGetPointerPosition() {
	...
	return (0, import_react.useCallback)(({ sourceEvent }) => {
		const { transform: transform$1, snapGrid, snapToGrid } = store.getState();
		const x = sourceEvent.touches ? sourceEvent.touches[0].clientX : sourceEvent.clientX;
		const y = sourceEvent.touches ? sourceEvent.touches[0].clientY : sourceEvent.clientY;
		const pointerPos = {
			x: (x - transform$1[0]) / transform$1[2],
			y: (y - transform$1[1]) / transform$1[2]
		};
		return {
...
function useDrag({ nodeRef, disabled = false, noDragClassName, handleSelector, nodeId, isSelectable, selectNodesOnDrag }) {
	...
	(0, import_react.useEffect)(() => {
		if (nodeRef?.current) {
			const selection$1 = select_default(nodeRef.current);
			...
			const autoPan = () => {
				...
				if (xMovement !== 0 || yMovement !== 0) {
					const { transform: transform$1, panBy } = store.getState();
					lastPos.current.x = (lastPos.current.x ?? 0) - xMovement / transform$1[2];
					lastPos.current.y = (lastPos.current.y ?? 0) - yMovement / transform$1[2];
					if (panBy({
						x: xMovement,
						y: yMovement
			...
			if (disabled) selection$1.on(".drag", null);
			else {
...
var wrapNode = (NodeComponent) => {
	const NodeWrapper = ({ id: id$1, type, data, xPos, yPos, xPosOrigin, yPosOrigin, selected, onClick, onMouseEnter, onMouseMove, onMouseLeave, onContextMenu, onDoubleClick, style: style$1, className, isDraggable, isSelectable, isConnectable, isFocusable, selectNodesOnDrag, sourcePosition, targetPosition, hidden, resizeObserver, dragHandle, zIndex, isParent, noDragClassName, noPanClassName, initialized, disableKeyboardA11y, ariaLabel, rfId, hasHandleBounds }) => {
		const store = useStoreApi();
		...
		const onMouseEnterHandler = getMouseHandler(id$1, store.getState, onMouseEnter);
		const onMouseMoveHandler = getMouseHandler(id$1, store.getState, onMouseMove);
		const onMouseLeaveHandler = getMouseHandler(id$1, store.getState, onMouseLeave);
		const onContextMenuHandler = getMouseHandler(id$1, store.getState, onContextMenu);
		const onDoubleClickHandler = getMouseHandler(id$1, store.getState, onDoubleClick);
		const onSelectNodeHandler = (event) => {
			...
			if (onClick) {
				const node = store.getState().nodeInternals.get(id$1);
		...
		}, import_react.createElement(Provider, { value: id$1 }, import_react.createElement(NodeComponent, {
			id: id$1,
			data,
			type,
			xPos,
...
var FlowRenderer = ({ children: children$1, onPaneClick, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, onPaneContextMenu, onPaneScroll, deleteKeyCode, onMove, onMoveStart, onMoveEnd, selectionKeyCode, selectionOnDrag, selectionMode, onSelectionStart, onSelectionEnd, multiSelectionKeyCode, panActivationKeyCode, zoomActivationKeyCode, elementsSelectable, zoomOnScroll, zoomOnPinch, panOnScroll: _panOnScroll, panOnScrollSpeed, panOnScrollMode, zoomOnDoubleClick, panOnDrag: _panOnDrag, defaultViewport, translateExtent, minZoom, maxZoom, preventScrolling, onSelectionContextMenu, noWheelClassName, noPanClassName, disableKeyboardA11y }) => {
	...
	return import_react.createElement(ZoomPane, {
		...
		selectionMode
	}, children$1, nodesSelectionActive && import_react.createElement(NodesSelection$1, {
...
var wrapEdge = (EdgeComponent) => {
	const EdgeWrapper = ({ id: id$1, className, type, data, onClick, onEdgeDoubleClick, selected, animated, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style$1, source, target, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, elementsSelectable, hidden, sourceHandleId, targetHandleId, onContextMenu, onMouseEnter, onMouseMove, onMouseLeave, reconnectRadius, onReconnect, onReconnectStart, onReconnectEnd, markerEnd, markerStart, rfId, ariaLabel, isFocusable, isReconnectable, pathOptions, interactionWidth, disableKeyboardA11y }) => {
		const edgeRef = (0, import_react.useRef)(null);
		...
		const onEdgeClick = (event) => {
			...
			const edge = edges.find((e) => e.id === id$1);
			if (!edge) return;
			if (elementsSelectable) {
				...
				} else addSelectedEdges([id$1]);
			}
			if (onClick) onClick(event, edge);
		};
		const onEdgeDoubleClickHandler = getMouseHandler$1(id$1, store.getState, onEdgeDoubleClick);
		const onEdgeContextMenu = getMouseHandler$1(id$1, store.getState, onContextMenu);
		const onEdgeMouseEnter = getMouseHandler$1(id$1, store.getState, onMouseEnter);
		const onEdgeMouseMove = getMouseHandler$1(id$1, store.getState, onMouseMove);
		const onEdgeMouseLeave = getMouseHandler$1(id$1, store.getState, onMouseLeave);
		...
		const onKeyDown = (event) => {
			if (!disableKeyboardA11y && elementSelectionKeys.includes(event.key) && elementsSelectable) {
				...
				if (event.key === "Escape") {
					edgeRef.current?.blur();
					unselectNodesAndEdges({ edges: [edges.find((e) => e.id === id$1)] });
				} else addSelectedEdges([id$1]);
			}
		};
		return import_react.createElement("g", {
...
function isEdgeVisible({ sourcePos, targetPos, sourceWidth, sourceHeight, targetWidth, targetHeight, width, height, transform: transform$1 }) {
	const edgeBox = {
	...
	const viewBox = rectToBox({
		x: (0 - transform$1[0]) / transform$1[2],
		y: (0 - transform$1[1]) / transform$1[2],
		width: width / transform$1[2],
		height: height / transform$1[2]
	});
...
function groupEdgesByZLevel(edges, nodeInternals, elevateEdgesOnSelect = false) {
	...
	const edgeTree = Object.entries(levelLookup).map(([key, edges$1]) => {
		const level = +key;
		return {
			edges: edges$1,
			level,
...
var ArrowSymbol = ({ color: color$1 = "none", strokeWidth = 1 }) => {
...
var ArrowClosedSymbol = ({ color: color$1 = "none", strokeWidth = 1 }) => {
	return import_react.createElement("polyline", {
		style: {
			stroke: color$1,
			fill: color$1,
...
var Marker = ({ id: id$1, type, color: color$1, width = 12.5, height = 12.5, markerUnits = "strokeWidth", strokeWidth, orient = "auto-start-reverse" }) => {
	const Symbol$1 = useMarkerSymbol(type);
	...
	return import_react.createElement("marker", {
		...
		refX: "0",
		refY: "0"
	}, import_react.createElement(Symbol$1, {
		color: color$1,
		strokeWidth
	}));
};
var markerSelector = ({ defaultColor: defaultColor$1, rfId }) => (s) => {
	const ids = [];
		...
		[edge.markerStart, edge.markerEnd].forEach((marker) => {
			if (marker && typeof marker === "object") {
				...
				if (!ids.includes(markerId)) {
					markers.push({
						id: markerId,
						color: marker.color || defaultColor$1,
						...marker
					});
					ids.push(markerId);
				}
...
var MarkerDefinitions = ({ defaultColor: defaultColor$1, rfId }) => {
	const markers = useStore((0, import_react.useCallback)(markerSelector({
		defaultColor: defaultColor$1,
		rfId
	}), [defaultColor$1, rfId]), (a, b) => !(a.length !== b.length || a.some((m, i) => m.id !== b[i].id)));
...
function Viewport({ children: children$1 }) {
	const transform$1 = useStore(selector$3$1);
	return import_react.createElement("div", {
		className: "react-flow__viewport react-flow__container",
		style: { transform: transform$1 }
	}, children$1);
}
...
var ConnectionLine = ({ nodeId, handleType, style: style$1, type = ConnectionLineType.Bezier, CustomComponent, connectionStatus }) => {
...
function ConnectionLineWrapper({ containerStyle: containerStyle$1, style: style$1, type, component }) {
...
var createRFStore = () => createWithEqualityFn((set$2, get$2) => ({
	...initialState,
	setNodes: (nodes) => {
		const { nodeInternals, nodeOrigin, elevateNodesOnSelect } = get$2();
		set$2({ nodeInternals: createNodeInternals(nodes, nodeInternals, nodeOrigin, elevateNodesOnSelect) });
	},
	getNodes: () => {
		return Array.from(get$2().nodeInternals.values());
	},
	setEdges: (edges) => {
		const { defaultEdgeOptions = {} } = get$2();
		set$2({ edges: edges.map((e) => ({
			...defaultEdgeOptions,
			...e
		})) });
	},
	setDefaultNodesAndEdges: (nodes, edges) => {
		...
		const nodeInternals = hasDefaultNodes ? createNodeInternals(nodes, /* @__PURE__ */ new Map(), get$2().nodeOrigin, get$2().elevateNodesOnSelect) : /* @__PURE__ */ new Map();
		set$2({
			nodeInternals,
	...
	updateNodeDimensions: (updates) => {
		const { onNodesChange, nodeInternals, fitViewOnInit, fitViewOnInitDone, fitViewOnInitOptions, domNode, nodeOrigin } = get$2();
		const viewportNode = domNode?.querySelector(".react-flow__viewport");
		if (!viewportNode) return;
		const style$1 = window.getComputedStyle(viewportNode);
		const { m22: zoom } = new window.DOMMatrixReadOnly(style$1.transform);
		...
		const nextFitViewOnInitDone = fitViewOnInitDone || fitViewOnInit && !fitViewOnInitDone && fitView(get$2, {
			initial: true,
	...
	updateNodePositions: (nodeDragItems, positionChanged = true, dragging = false) => {
		const { triggerNodeChanges } = get$2();
	...
	triggerNodeChanges: (changes) => {
		const { onNodesChange, nodeInternals, hasDefaultNodes, nodeOrigin, getNodes, elevateNodesOnSelect } = get$2();
		if (changes?.length) {
			if (hasDefaultNodes) {
				const nodes = applyNodeChanges(changes, getNodes());
				const nextNodeInternals = createNodeInternals(nodes, nodeInternals, nodeOrigin, elevateNodesOnSelect);
				set$2({ nodeInternals: nextNodeInternals });
			}
			onNodesChange?.(changes);
		}
	},
	addSelectedNodes: (selectedNodeIds) => {
		const { multiSelectionActive, edges, getNodes } = get$2();
		let changedNodes;
	...
	unselectNodesAndEdges: ({ nodes, edges } = {}) => {
		const { edges: storeEdges, getNodes } = get$2();
	...
	setMinZoom: (minZoom) => {
		const { d3Zoom, maxZoom } = get$2();
		d3Zoom?.scaleExtent([minZoom, maxZoom]);
		set$2({ minZoom });
	},
	setMaxZoom: (maxZoom) => {
		const { d3Zoom, minZoom } = get$2();
		d3Zoom?.scaleExtent([minZoom, maxZoom]);
		set$2({ maxZoom });
	},
	setTranslateExtent: (translateExtent) => {
		get$2().d3Zoom?.translateExtent(translateExtent);
		set$2({ translateExtent });
	},
	resetSelectedElements: () => {
		const { edges, getNodes } = get$2();
		const nodesToUnselect = getNodes().filter((e) => e.selected).map((n) => createSelectionChange(n.id, false));
	...
	panBy: (delta) => {
		const { transform: transform$1, width, height, d3Zoom, d3Selection, translateExtent } = get$2();
		if (!d3Zoom || !d3Selection || !delta.x && !delta.y) return false;
		const nextTransform = identity.translate(transform$1[0] + delta.x, transform$1[1] + delta.y).scale(transform$1[2]);
		const extent = [[0, 0], [width, height]];
		const constrainedTransform = d3Zoom?.constrain()(nextTransform, extent, translateExtent);
		d3Zoom.transform(d3Selection, constrainedTransform);
		return transform$1[0] !== constrainedTransform.x || transform$1[1] !== constrainedTransform.y || transform$1[2] !== constrainedTransform.k;
	},
	cancelConnection: () => set$2({
	...
	reset: () => set$2({ ...initialState })
}), Object.is);
var ReactFlowProvider = ({ children: children$1 }) => {
	const storeRef = (0, import_react.useRef)(null);
	if (!storeRef.current) storeRef.current = createRFStore();
	return import_react.createElement(Provider$1, { value: storeRef.current }, children$1);
};
ReactFlowProvider.displayName = "ReactFlowProvider";
var Wrapper = ({ children: children$1 }) => {
	if ((0, import_react.useContext)(StoreContext)) return import_react.createElement(import_react.Fragment, null, children$1);
	return import_react.createElement(ReactFlowProvider, null, children$1);
};
...
var ReactFlow = (0, import_react.forwardRef)(({ nodes, edges, defaultNodes, defaultEdges, className, nodeTypes = defaultNodeTypes, edgeTypes = defaultEdgeTypes, onNodeClick, onEdgeClick, onInit, onMove, onMoveStart, onMoveEnd, onConnect, onConnectStart, onConnectEnd, onClickConnectStart, onClickConnectEnd, onNodeMouseEnter, onNodeMouseMove, onNodeMouseLeave, onNodeContextMenu, onNodeDoubleClick, onNodeDragStart, onNodeDrag, onNodeDragStop, onNodesDelete, onEdgesDelete, onSelectionChange, onSelectionDragStart, onSelectionDrag, onSelectionDragStop, onSelectionContextMenu, onSelectionStart, onSelectionEnd, connectionMode = ConnectionMode.Strict, connectionLineType = ConnectionLineType.Bezier, connectionLineStyle, connectionLineComponent, connectionLineContainerStyle, deleteKeyCode = "Backspace", selectionKeyCode = "Shift", selectionOnDrag = false, selectionMode = SelectionMode.Full, panActivationKeyCode = "Space", multiSelectionKeyCode = isMacOs() ? "Meta" : "Control", zoomActivationKeyCode = isMacOs() ? "Meta" : "Control", snapToGrid = false, snapGrid = initSnapGrid, onlyRenderVisibleElements = false, selectNodesOnDrag = true, nodesDraggable, nodesConnectable, nodesFocusable, nodeOrigin = initNodeOrigin, edgesFocusable, edgesUpdatable, elementsSelectable, defaultViewport = initDefaultViewport, minZoom = .5, maxZoom = 2, translateExtent = infiniteExtent, preventScrolling = true, nodeExtent, defaultMarkerColor = "#b1b1b7", zoomOnScroll = true, zoomOnPinch = true, panOnScroll = false, panOnScrollSpeed = .5, panOnScrollMode = PanOnScrollMode.Free, zoomOnDoubleClick = true, panOnDrag = true, onPaneClick, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, onPaneScroll, onPaneContextMenu, children: children$1, onEdgeContextMenu, onEdgeDoubleClick, onEdgeMouseEnter, onEdgeMouseMove, onEdgeMouseLeave, onEdgeUpdate, onEdgeUpdateStart, onEdgeUpdateEnd, onReconnect, onReconnectStart, onReconnectEnd, reconnectRadius = 10, edgeUpdaterRadius = 10, onNodesChange, onEdgesChange, noDragClassName = "nodrag", noWheelClassName = "nowheel", noPanClassName = "nopan", fitView: fitView$1 = false, fitViewOptions, connectOnClick = true, attributionPosition, proOptions, defaultEdgeOptions, elevateNodesOnSelect = true, elevateEdgesOnSelect = false, disableKeyboardA11y = false, autoPanOnConnect = true, autoPanOnNodeDrag = true, connectionRadius = 20, isValidConnection, onError, style: style$1, id: id$1, nodeDragThreshold,...rest }, ref) => {
	...
	return import_react.createElement("div", {
		...
		isValidConnection,
		nodeDragThreshold
	}), import_react.createElement(Wrapper$1, { onSelectionChange }), children$1, import_react.createElement(Attribution, {
		proOptions,
...
function EdgeLabelRenderer({ children: children$1 }) {
	const edgeLabelRenderer = useStore(selector$1$2);
	if (!edgeLabelRenderer) return null;
	return (0, import_react_dom$1.createPortal)(children$1, edgeLabelRenderer);
}
function useUpdateNodeInternals() {
	const store = useStoreApi();
	return (0, import_react.useCallback)((id$1) => {
		const { domNode, updateNodeDimensions } = store.getState();
		const updates = (Array.isArray(id$1) ? id$1 : [id$1]).reduce((res, updateId) => {
...
function createUseItemsState(applyChanges$1) {
	return (initialItems) => {
		const [items, setItems] = (0, import_react.useState)(initialItems);
		const onItemsChange = (0, import_react.useCallback)((changes) => setItems((items$1) => applyChanges$1(changes, items$1)), []);
		return [
			items,
			setItems,
			onItemsChange
...
var MiniMapNode = ({ id: id$1, x, y, width, height, style: style$1, color: color$1, strokeColor, strokeWidth, className, borderRadius, shapeRendering, onClick, selected }) => {
	const { background, backgroundColor } = style$1 || {};
	const fill = color$1 || background || backgroundColor;
	return import_react.createElement("rect", {
		...
		strokeWidth,
		shapeRendering,
		onClick: onClick ? (event) => onClick(event, id$1) : void 0
	});
};
...
function MiniMap({ style: style$1, className, nodeStrokeColor = "transparent", nodeColor = "#e2e2e2", nodeClassName = "", nodeBorderRadius = 5, nodeStrokeWidth = 2, nodeComponent, maskColor = "rgb(240, 240, 240, 0.6)", maskStrokeColor = "none", maskStrokeWidth = 1, position = "bottom-right", onClick, onNodeClick, pannable = false, zoomable = false, ariaLabel = "React Flow mini map", inversePan = false, zoomStep = 10, offsetScale = 5 }) {
	...
	(0, import_react.useEffect)(() => {
		if (svg.current) {
			const selection$1 = select_default(svg.current);
			const zoomHandler = (event) => {
				const { transform: transform$1, d3Selection, d3Zoom } = store.getState();
				...
				const zoom = transform$1[2] * Math.pow(2, pinchDelta);
				d3Zoom.scaleTo(d3Selection, zoom);
			};
			const panHandler = (event) => {
				const { transform: transform$1, d3Selection, d3Zoom, translateExtent, width: width$1, height: height$1 } = store.getState();
				if (event.sourceEvent.type !== "mousemove" || !d3Selection || !d3Zoom) return;
				const moveScale = viewScaleRef.current * Math.max(1, transform$1[2]) * (inversePan ? -1 : 1);
				const position$1 = {
					x: transform$1[0] - event.sourceEvent.movementX * moveScale,
					y: transform$1[1] - event.sourceEvent.movementY * moveScale
				};
				const extent = [[0, 0], [width$1, height$1]];
				const nextTransform = identity.translate(position$1.x, position$1.y).scale(transform$1[2]);
				const constrainedTransform = d3Zoom.constrain()(nextTransform, extent, translateExtent);
				d3Zoom.transform(d3Selection, constrainedTransform);
			};
			const zoomAndPanHandler = zoom_default().on("zoom", pannable ? panHandler : null).on("zoom.wheel", zoomable ? zoomHandler : null);
			selection$1.call(zoomAndPanHandler);
			return () => {
				selection$1.on("zoom", null);
			};
		}
	}, [
		pannable,
...
var ControlButton = ({ children: children$1, className,...rest }) => import_react.createElement("button", {
	type: "button",
...
var Controls = ({ style: style$1, showZoom = true, showFitView = true, showInteractive = true, fitViewOptions, onZoomIn, onZoomOut, onFitView, onInteractiveChange, className, children: children$1, position = "bottom-left" }) => {
	const store = useStoreApi();
	const [isVisible, setIsVisible] = (0, import_react.useState)(false);
	const { isInteractive, minZoomReached, maxZoomReached } = useStore(selector$2, shallow$1);
	const { zoomIn, zoomOut, fitView: fitView$1 } = useReactFlow();
	(0, import_react.useEffect)(() => {
		setIsVisible(true);
	}, []);
	...
	}, isInteractive ? import_react.createElement(UnlockIcon, null) : import_react.createElement(LockIcon, null)), children$1);
};
...
(function(BackgroundVariant$1) {
	BackgroundVariant$1["Lines"] = "lines";
	BackgroundVariant$1["Dots"] = "dots";
	BackgroundVariant$1["Cross"] = "cross";
})(BackgroundVariant || (BackgroundVariant = {}));
function LinePattern({ color: color$1, dimensions, lineWidth }) {
	return import_react.createElement("path", {
		stroke: color$1,
...
function DotPattern({ color: color$1, radius }) {
...
function Background({ id: id$1, variant = BackgroundVariant.Dots, gap = 20, size, lineWidth = 1, offset = 2, color: color$1, style: style$1, className }) {
	const ref = (0, import_react.useRef)(null);
	const { transform: transform$1, patternId } = useStore(selector$1, shallow$1);
	const patternColor = color$1 || defaultColor[variant];
	const patternSize = size || defaultSize[variant];
	const isDots = variant === BackgroundVariant.Dots;
	const isCross = variant === BackgroundVariant.Cross;
	const gapXY = Array.isArray(gap) ? gap : [gap, gap];
	const scaledGap = [gapXY[0] * transform$1[2] || 1, gapXY[1] * transform$1[2] || 1];
	const scaledSize = patternSize * transform$1[2];
	...
	return import_react.createElement("svg", {
		...
		id: patternId + id$1,
		x: transform$1[0] % scaledGap[0],
		y: transform$1[1] % scaledGap[1],
		width: scaledGap[0],
		height: scaledGap[1],
...
function NodeToolbarPortal({ children: children$1 }) {
	const wrapperRef = useStore(selector);
	if (!wrapperRef) return null;
	return (0, import_react_dom.createPortal)(children$1, wrapperRef);
}
...
function getTransform(nodeRect, transform$1, position, offset, align) {
	let alignmentOffset = .5;
	if (align === "start") alignmentOffset = 0;
	else if (align === "end") alignmentOffset = 1;
	let pos = [(nodeRect.x + nodeRect.width * alignmentOffset) * transform$1[2] + transform$1[0], nodeRect.y * transform$1[2] + transform$1[1] - offset];
	let shift = [-100 * alignmentOffset, -100];
	switch (position) {
		case Position.Right:
			pos = [(nodeRect.x + nodeRect.width) * transform$1[2] + transform$1[0] + offset, (nodeRect.y + nodeRect.height * alignmentOffset) * transform$1[2] + transform$1[1]];
			shift = [0, -100 * alignmentOffset];
			break;
		case Position.Bottom:
			pos[1] = (nodeRect.y + nodeRect.height) * transform$1[2] + transform$1[1] + offset;
			shift[1] = 0;
			break;
		case Position.Left:
			pos = [nodeRect.x * transform$1[2] + transform$1[0] - offset, (nodeRect.y + nodeRect.height * alignmentOffset) * transform$1[2] + transform$1[1]];
			shift = [-100, -100 * alignmentOffset];
			break;
	}
	return `translate(${pos[0]}px, ${pos[1]}px) translate(${shift[0]}%, ${shift[1]}%)`;
}
function NodeToolbar({ nodeId, children: children$1, className, style: style$1, isVisible, position = Position.Top, offset = 10, align = "center",...rest }) {
	const contextNodeId = useNodeId();
	const nodesSelector$1 = (0, import_react.useCallback)((state) => {
		return (Array.isArray(nodeId) ? nodeId : [nodeId || contextNodeId || ""]).reduce((acc, id$1) => {
			const node = state.nodeInternals.get(id$1);
			if (node) acc.push(node);
			return acc;
		}, []);
	}, [nodeId, contextNodeId]);
	const nodes = useStore(nodesSelector$1, nodesEqualityFn);
	const { transform: transform$1, nodeOrigin, selectedNodesCount } = useStore(storeSelector, shallow$1);
	...
	const wrapperStyle$1 = {
		position: "absolute",
		transform: getTransform(nodeRect, transform$1, position, offset, align),
		zIndex,
		...style$1
	};
...
(function(ResizeControlVariant$1) {
	ResizeControlVariant$1["Line"] = "line";
	ResizeControlVariant$1["Handle"] = "handle";
...
function ResizeControl({ nodeId, position, variant = ResizeControlVariant.Handle, className, style: style$1 = {}, children: children$1, color: color$1, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd }) {
	const contextNodeId = useNodeId();
	const id$1 = typeof nodeId === "string" ? nodeId : contextNodeId;
	const store = useStoreApi();
	...
	(0, import_react.useEffect)(() => {
		if (!resizeControlRef.current || !id$1) return;
		const selection$1 = select_default(resizeControlRef.current);
	...
	const controlStyle = color$1 ? {
		...style$1,
		[colorStyleProp]: color$1
	} : style$1;
	return import_react.createElement("div", {
		className: cc([
...
function NodeResizer({ nodeId, isVisible = true, handleClassName, handleStyle, lineClassName, lineStyle, color: color$1, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd }) {
	if (!isVisible) return null;
...
//#endregion
export { Background$1 as Background, BackgroundVariant, BaseEdge, BezierEdge, ConnectionLineType, ConnectionMode, ControlButton, Controls$1 as Controls, EdgeLabelRenderer, EdgeText$1 as EdgeText, Handle$1 as Handle, MarkerType, MiniMap$1 as MiniMap, ResizeControl$1 as NodeResizeControl, NodeResizer, NodeToolbar, PanOnScrollMode, Panel, Position, ReactFlow, ReactFlowProvider, ResizeControlVariant, SelectionMode, SimpleBezierEdge, SmoothStepEdge, StepEdge, StraightEdge, addEdge, applyEdgeChanges, applyNodeChanges, boxToRect, clamp, ReactFlow as default, getBezierPath, getBoundsOfRects, getConnectedEdges, getIncomers, getMarkerEnd, getNodePositionWithOrigin, getNodesBounds, getOutgoers, getRectOfNodes, getSimpleBezierPath, getSmoothStepPath, getStraightPath, getTransformForBounds, getViewportForBounds, handleParentExpand, internalsSymbol, isEdge, isNode, reconnectEdge, rectToBox, updateEdge, useEdges, useEdgesState, useGetPointerPosition, useKeyPress, useNodeId, useNodes, useNodesInitialized, useNodesState, useOnSelectionChange, useOnViewportChange, useReactFlow, useStore, useStoreApi, useUpdateNodeInternals, useViewport };
