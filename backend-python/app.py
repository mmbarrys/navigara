...
load_dotenv()
app = Flask(__name__)
NETLIFY_URL = "https://navigara.netlify.app" 
NGROK_URL = "https://nonerroneously-unvoluptuous-alena.ngrok-free.dev"
CORS(app, origins=[NETLIFY_URL, NGROK_URL, "http://localhost:5173"])
...
def lentera_generate_case():
    app.logger.info(f"Request from Origin: {request.origin}")
